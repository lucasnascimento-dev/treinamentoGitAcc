		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapui5odataprojectodata3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5odataprojectodata3-display": {
								"semanticObject": "sapui5odataprojectodata3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ui5.odata.projectodata3",
									"url": sap.ui.require.toUrl("sap/ui5/odata/projectodata3")
								}
							}
						}
					}
